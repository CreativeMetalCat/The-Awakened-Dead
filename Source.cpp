...
int main(int argc, char** argv)
{
	...
	game.Resources->AddSoundResource(new SoundResource("footstep_concrete1", "./../sounds/player/footsteps/concrete1.wav"));
	game.Resources->AddSoundResource(new SoundResource("footstep_concrete2", "./../sounds/player/footsteps/concrete2.wav"));
	game.Resources->AddSoundResource(new SoundResource("footstep_concrete3", "./../sounds/player/footsteps/concrete3.wav"));
	game.Resources->AddSoundResource(new SoundResource("footstep_concrete4", "./../sounds/player/footsteps/concrete4.wav"));
